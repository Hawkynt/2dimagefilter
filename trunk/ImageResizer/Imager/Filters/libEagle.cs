...
namespace nImager.Filters {
  static class libEagle {
    ...
    public static void voidEagle3xB(cImage objSrc, ulong qwordSrcX, ulong qwordSrcY, cImage objTgt, ulong qwordTgtX, ulong qwordTgtY, byte byteScaleX, byte byteScaleY, object objParam) {
      sPixel stPixel = objSrc[qwordSrcX, qwordSrcY];
      sPixel stC0 = objSrc[qwordSrcX - 1, qwordSrcY - 1];
      sPixel stC1 = objSrc[qwordSrcX, qwordSrcY - 1];
      sPixel stC2 = objSrc[qwordSrcX + 1, qwordSrcY - 1];
      ...
      if ((stC1.IsLike(stC0)) && (stC1.IsLike(stC2)))
        stE01 = sPixel.Interpolate(stC1,stC0,stC2);

      if ((stC5.IsLike(stC2)) && (stC5.IsLike(stC8)))
        stE12 = sPixel.Interpolate(stC5,stC2,stC8);

      if ((stC7.IsLike(stC6)) && (stC7.IsLike(stC8)))
        stE21 = sPixel.Interpolate(stC7,stC6,stC8);

      if ((stC3.IsLike(stC0)) && (stC3.IsLike(stC6)))
        stE10 = sPixel.Interpolate(stC3,stC0,stC6);
