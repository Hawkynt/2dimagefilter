...
$_hashFilters->{'Scale2x'}     =arr(\&_voidComplex_PnQwXh    ,2,2,1,1);
    ...
    #region standard AdvInterp3x casepath
    public static sPixel[] _arrAdvInterp3x(byte bytePattern,sPixel stC0,sPixel stC1,sPixel stC2,sPixel stC3,sPixel stC4,sPixel stC5,sPixel stC6,sPixel stC7,sPixel stC8) {
      sPixel stE00=stC4;
      sPixel stE01=stC4;
      sPixel stE02=stC4;
      sPixel stE10=stC4;
      ...
      sPixel stE21=stC4;
      sPixel stE22=stC4;
      #region AdvInterp3x PATTERNS

    if ((stC1!= stC7 ) && (stC3!= stC5 )) {
  if ((stC1== stC3 )) {
        stE00=sPixel.Interpolate(stC3,stC4,5,3);
  };
  ...
  if ((stC1== stC5 )) {
        stE02=sPixel.Interpolate(stC5,stC4,5,3);
  };
  ...
  if ((stC7== stC3 )) {
        stE20=sPixel.Interpolate(stC3,stC4,5,3);
  };
  ...
  if ((stC7== stC5 )) {
        stE22=sPixel.Interpolate(stC5,stC4,5,3);
  };
    }
    ...
    #endregion
    #region standard AdvInterpH3x casepath
    public static sPixel[] _arrAdvInterpH3x(byte bytePattern,sPixel stC0,sPixel stC1,sPixel stC2,sPixel stC3,sPixel stC4,sPixel stC5,sPixel stC6,sPixel stC7,sPixel stC8) {
      sPixel stE00=stC4;
      sPixel stE01=stC4;
      sPixel stE02=stC4;
      sPixel stE10=stC4;
      ...
      sPixel stE21=stC4;
      sPixel stE22=stC4;
      #region AdvInterpH3x PATTERNS
if (stC4.IsNotLike( stC0 )) {
  if (stC1.IsLike( stC3 )) {
        stE00=sPixel.Interpolate(stC1,stC3,1,1);
      }
    } else {
      stE01=sPixel.Interpolate(stC0,stC4,1,1);
      stE10=sPixel.Interpolate(stC0,stC4,1,1);
    }
  ...
  if (stC1.IsLike( stC5 )) {
      ...
      stE01=sPixel.Interpolate(stC2,stC4,1,1);
      stE12=sPixel.Interpolate(stC2,stC4,1,1);
    }

    if (stC4.IsNotLike( stC6 )) {
  if (stC7.IsLike( stC3 )) {
        stE20=sPixel.Interpolate(stC7,stC3,1,1);
      }
    } else {
      stE10=sPixel.Interpolate(stC6,stC4,1,1);
      stE21=sPixel.Interpolate(stC6,stC4,1,1);
    }

    if (stC4.IsNotLike( stC8 )) {
  if (stC7.IsLike( stC5 )) {
        stE22=sPixel.Interpolate(stC7,stC5,1,1);
      }
    } else {
      stE21=sPixel.Interpolate(stC8,stC4,1,1);
      stE12=sPixel.Interpolate(stC8,stC4,1,1);
}
      #endregion
      return (new sPixel[]{
      stE00, stE01, stE02, 
    ...
    #endregion
    #region standard Eagle2x casepath
    public static sPixel[] _arrEagle2x(byte bytePattern,sPixel stC0,sPixel stC1,sPixel stC2,sPixel stC3,sPixel stC4,sPixel stC5,sPixel stC6,sPixel stC7,sPixel stC8) {
      sPixel stE00=stC4;
      sPixel stE01=stC4;
      sPixel stE10=stC4;
      sPixel stE11=stC4;
      #region Eagle2x PATTERNS

    if (stC1.IsLike( stC0 ) && stC1.IsLike( stC3 )) {
      stE00=sPixel.Interpolate(stC0,stC1,stC3,1,1,1);
    }

    if (stC1.IsLike( stC2 ) && stC1.IsLike( stC5 )) {
      stE01=sPixel.Interpolate(stC1,stC2,stC5,1,1,1);
    }

    if (stC7.IsLike( stC6 ) && stC7.IsLike( stC3 )) {
      stE10=sPixel.Interpolate(stC3,stC6,stC7,1,1,1);
    }

    if (stC7.IsLike( stC8 ) && stC7.IsLike( stC5 )) {
      stE11=sPixel.Interpolate(stC5,stC7,stC8,1,1,1);
}
      #endregion
      return (new sPixel[]{
      stE00, stE01, 
    ...
    #endregion
    #region standard Eagle3x casepath
    public static sPixel[] _arrEagle3x(byte bytePattern,sPixel stC0,sPixel stC1,sPixel stC2,sPixel stC3,sPixel stC4,sPixel stC5,sPixel stC6,sPixel stC7,sPixel stC8) {
      sPixel stE00=stC4;
      sPixel stE01=stC4;
      sPixel stE02=stC4;
      sPixel stE10=stC4;
    ...
    if (stC1.IsLike( stC2 ) && stC1.IsLike( stC5 )) {
      stE02=sPixel.Interpolate(stC1,stC2,stC5,1,1,1);
    }

    if (stC7.IsLike( stC6 ) && stC7.IsLike( stC3 )) {
      stE20=sPixel.Interpolate(stC3,stC6,stC7,1,1,1);
    }

    if (stC7.IsLike( stC8 ) && stC7.IsLike( stC5 )) {
      stE22=sPixel.Interpolate(stC5,stC7,stC8,1,1,1);
    }

    if (stC1.IsLike( stC0 ) && stC1.IsLike( stC3 ) && stC1.IsLike( stC2 ) && stC1.IsLike( stC5 )) {
  my $varA=sPixel.Interpolate(stC0,stC1,stC3,1,1,1);
  my $varB=sPixel.Interpolate(stC1,stC2,stC5,1,1,1);
      stE01=sPixel.Interpolate($varA,$varB,1,1);
    }

    if (stC1.IsLike( stC2 ) && stC1.IsLike( stC5 ) && stC7.IsLike( stC8 ) && stC7.IsLike( stC5 )) {
  my $varA=sPixel.Interpolate(stC1,stC2,stC5,1,1,1);
  my $varB=sPixel.Interpolate(stC5,stC7,stC8,1,1,1);
      stE12=sPixel.Interpolate($varA,$varB,1,1);
    }

    if (stC7.IsLike( stC6 ) && stC7.IsLike( stC3 ) && stC7.IsLike( stC8 ) && stC7.IsLike( stC5 )) {
  my $varA=sPixel.Interpolate(stC3,stC6,stC7,1,1,1);
  my $varB=sPixel.Interpolate(stC5,stC7,stC8,1,1,1);
      stE21=sPixel.Interpolate($varA,$varB,1,1);
    }

    if (stC1.IsLike( stC0 ) && stC1.IsLike( stC3 ) && stC7.IsLike( stC6 ) && stC7.IsLike( stC3 )) {
  my $varA=sPixel.Interpolate(stC0,stC1,stC3,1,1,1);
  my $varB=sPixel.Interpolate(stC3,stC6,stC7,1,1,1);
      stE10=sPixel.Interpolate($varA,$varB,1,1);
}
      #endregion
      return (new sPixel[]{
      stE00, stE01, stE02, 
...
case 138 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC0,stC1,stC3,2,1,1);
      }
} break;
case 11 : 
case 27 : 
...
case 203 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC2,stC1,stC3,2,1,1);
      }
} break;
case 14 : 
case 142 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC1,stC3,stC0,3,3,2);
    P1 = sPixel.Interpolate(stC0,stC1,3,1);
      }
} break;
case 15 : 
case 143 : 
case 207 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC1,stC3,stC4,3,3,2);
    P1 = sPixel.Interpolate(stC4,stC1,3,1);
      }
} break;
case 18 : 
case 22 : 
...
case 118 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC0,stC1,stC5,2,1,1);
      }
} break;
case 19 : 
case 51 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P0 = sPixel.Interpolate(stC2,stC1,3,1);
    P1 = sPixel.Interpolate(stC1,stC5,stC2,3,3,2);
      }
} break;
case 23 : 
case 55 : 
case 119 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P0 = sPixel.Interpolate(stC3,stC1,3,1);
    P1 = sPixel.Interpolate(stC1,stC5,stC3,3,3,2);
      }
} break;
case 26 : 
{
...
case 95 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC4,stC1,stC3,2,1,1);
      }
  if (stC1.IsNotLike( stC5 )) {
    P1 = stC4;
      } else {
    P1 = sPixel.Interpolate(stC4,stC1,stC5,2,1,1);
      }
} break;
case 42 : 
case 170 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC1,stC3,stC0,3,3,2);
    P2 = sPixel.Interpolate(stC0,stC3,3,1);
      }
} break;
case 43 : 
case 171 : 
case 187 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC1,stC3,stC2,3,3,2);
    P2 = sPixel.Interpolate(stC2,stC3,3,1);
      }
} break;
case 46 : 
case 174 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC0,stC1,stC3,6,1,1);
      }
} break;
case 47 : 
case 175 : 
{
  ...
  if (stC1.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC4,stC1,stC3,14,1,1);
      }
} break;
case 58 : 
case 154 : 
case 186 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC0,stC1,stC5,6,1,1);
      }
} break;
case 59 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC2,stC1,stC5,6,1,1);
      }
} break;
case 63 : 
{
...
case 124 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC0,stC3,stC7,2,1,1);
      }
} break;
case 73 : 
case 77 : 
...
case 125 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P0 = sPixel.Interpolate(stC1,stC3,3,1);
    P2 = sPixel.Interpolate(stC3,stC7,stC1,3,3,2);
      }
} break;
case 74 : 
{
...
case 206 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC0,stC3,stC7,6,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC0;
      } else {
...
case 79 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC4,stC3,stC7,6,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC4;
      } else {
...
case 216 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC0,stC5,stC7,2,1,1);
      }
} break;
case 81 : 
case 209 : 
case 217 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC1,stC5,stC7,2,1,1);
      }
} break;
case 82 : 
case 214 : 
...
case 115 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC2,stC5,stC7,6,1,1);
      }
  if (stC1.IsNotLike( stC5 )) {
    P1 = stC2;
      } else {
...
case 212 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC0,stC5,3,1);
    P3 = sPixel.Interpolate(stC5,stC7,stC0,3,3,2);
      }
} break;
case 85 : 
case 213 : 
case 221 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC1,stC5,3,1);
    P3 = sPixel.Interpolate(stC5,stC7,stC1,3,3,2);
      }
} break;
case 87 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC3,stC5,stC7,6,1,1);
      }
  if (stC1.IsNotLike( stC5 )) {
    P1 = stC3;
      } else {
    P1 = sPixel.Interpolate(stC3,stC1,stC5,2,1,1);
      }
} break;
case 88 : 
case 248 : 
...
case 93 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC1,stC3,stC7,6,1,1);
      }
  if (stC7.IsNotLike( stC5 )) {
    P3 = stC1;
      } else {
    P3 = sPixel.Interpolate(stC1,stC5,stC7,6,1,1);
      }
} break;
case 90 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC0,stC5,stC7,6,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC0;
      } else {
...
case 91 : 
{
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC2,stC3,stC7,6,1,1);
      }
  if (stC7.IsNotLike( stC5 )) {
    P3 = stC2;
      } else {
...
case 123 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC2,stC3,stC7,2,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC2;
      } else {
...
case 111 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC4,stC3,stC7,2,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC4;
      } else {
...
case 240 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P2 = sPixel.Interpolate(stC0,stC7,3,1);
    P3 = sPixel.Interpolate(stC5,stC7,stC0,3,3,2);
      }
} break;
case 113 : 
case 241 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P2 = sPixel.Interpolate(stC1,stC7,3,1);
    P3 = sPixel.Interpolate(stC5,stC7,stC1,3,3,2);
      }
} break;
case 114 : 
...
case 121 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC1,stC3,stC7,2,1,1);
      }
  if (stC7.IsNotLike( stC5 )) {
    P3 = stC1;
      } else {
...
case 190 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC1,stC5,stC0,3,3,2);
    P3 = sPixel.Interpolate(stC0,stC5,3,1);
      }
} break;
case 147 : 
case 179 : 
...
case 183 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC3,stC1,stC5,14,1,1);
      }
} break;
case 158 : 
{
...
case 159 : 
{
  ...
  if (stC1.IsNotLike( stC5 )) {
    ...
    P1 = sPixel.Interpolate(stC4,stC1,stC5,14,1,1);
      }
} break;
case 191 : 
{
...
case 238 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC3,stC7,stC0,3,3,2);
    P3 = sPixel.Interpolate(stC0,stC7,3,1);
      }
} break;
case 201 : 
case 205 : 
...
case 211 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC2,stC5,stC7,2,1,1);
      }
} break;
case 215 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC3,stC5,stC7,2,1,1);
      }
  if (stC1.IsNotLike( stC5 )) {
    P1 = stC3;
      } else {
...
case 223 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC4,stC5,stC7,2,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC4;
      } else {
...
case 237 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC1,stC3,stC7,14,1,1);
      }
} break;
case 234 : 
{
...
case 235 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC2,stC3,stC7,14,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC2;
      } else {
...
case 239 : 
{
  ...
  if (stC7.IsNotLike( stC3 )) {
    ...
    P2 = sPixel.Interpolate(stC4,stC3,stC7,14,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC4;
      } else {
...
case 243 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P2 = sPixel.Interpolate(stC2,stC7,3,1);
    P3 = sPixel.Interpolate(stC5,stC7,stC2,3,3,2);
      }
} break;
case 244 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC0,stC5,stC7,14,1,1);
      }
} break;
case 245 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC1,stC5,stC7,14,1,1);
      }
} break;
case 246 : 
{
...
case 247 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC3,stC5,stC7,14,1,1);
      }
  if (stC1.IsNotLike( stC5 )) {
    P1 = stC3;
      } else {
...
case 255 : 
{
  ...
  if (stC7.IsNotLike( stC5 )) {
    ...
    P3 = sPixel.Interpolate(stC4,stC5,stC7,14,1,1);
      }
  if (stC1.IsNotLike( stC3 )) {
    P0 = stC4;
      } else {
...
case 255 : 
{
    ...
    #endregion
    #region standard Scale2x casepath
    public static sPixel[] _arrScale2x(byte bytePattern,sPixel stC0,sPixel stC1,sPixel stC2,sPixel stC3,sPixel stC4,sPixel stC5,sPixel stC6,sPixel stC7,sPixel stC8) {
      sPixel stE00=stC4;
      sPixel stE01=stC4;
      sPixel stE10=stC4;
      sPixel stE11=stC4;
      #region Scale2x PATTERNS
  ...
  if (stC1.IsLike( stC5 )) { 
        stE01=sPixel.Interpolate(stC1,stC5,1,1);
  };
  if (stC7.IsLike( stC3 )) { 
        stE10=sPixel.Interpolate(stC7,stC3,1,1); 
  };
  if (stC7.IsLike( stC5 )) { 
        stE11=sPixel.Interpolate(stC7,stC5,1,1); 
  };
}
      #endregion
      return (new sPixel[]{
