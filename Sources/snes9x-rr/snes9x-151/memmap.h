...
uint16	S9xGetWord (uint32 Address, enum s9xwrap_t w = WRAP_NONE, bool free = false);
void	S9xSetWord (uint16 Word, uint32 Address, enum s9xwrap_t w = WRAP_NONE, enum s9xwriteorder_t o = WRITE_01, bool free = false);
