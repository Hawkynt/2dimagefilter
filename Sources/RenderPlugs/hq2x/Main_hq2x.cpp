...
extern "C"
{
	void hq2x_16_565(unsigned char *src, unsigned char *dst, unsigned long sw, unsigned long sh, unsigned long dpitch, unsigned long spitch);
	void hq2x_16_555(unsigned char *src, unsigned char *dst, unsigned long sw, unsigned long sh, unsigned long dpitch, unsigned long spitch);
...
RenderPluginGetInfo(void)
{
	...
	//                         "............................................................"
	rpi_strcpy(&MyRPI.Name[0], "hq2x (Maxim Stepin)");
...
RenderPluginOutput(RENDER_PLUGIN_OUTP *rpo)
{
	...
	{
		if(VideoFormat==0)	hq2x_16_565((unsigned char *)rpo->SrcPtr, (unsigned char *)rpo->DstPtr, rpo->SrcW, rpo->SrcH, rpo->DstPitch, rpo->SrcPitch);
		if(VideoFormat==1)	hq2x_16_555((unsigned char *)rpo->SrcPtr, (unsigned char *)rpo->DstPtr, rpo->SrcW, rpo->SrcH, rpo->DstPitch, rpo->SrcPitch);
	}
